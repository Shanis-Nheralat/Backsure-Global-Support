...
define('DB_NAME', 'backsure_admin');  // Update this to match your database name
define('DB_USER', 'shanis@backsureglobalsupport.com');  // Update this with your database username
define('DB_PASSWORD', 'lBzymn$l2h1$wpYoo9RV');  // Update this with your database password

// Security settings
define('SECURE_COOKIES', true);  // Set to false in development if not using HTTPS
