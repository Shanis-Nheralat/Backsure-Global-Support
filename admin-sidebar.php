 ...
 * Still preserves dynamic functionality through admin-menu-config.php
 */
...
<aside class="admin-sidebar">
  ...
  <nav class="sidebar-nav">
    <ul>
          ...
          <li class="<?php echo ($current_page === 'inquiries') ? 'active' : ''; ?>">
            <a href="admin-inquiries.php">
              ...
              <?php if (isset($unread_inquiries) && $unread_inquiries > 0): ?>
                <span class="badge"><?php echo $unread_inquiries; ?></span>
              <?php endif; ?>
            </a>
          </li>
      ...
      <!-- Site Settings -->
      <?php if (user_has_permission('manage_settings')): ?>
      ...
      <?php 
      // Optionally, still use the dynamic menu for any additional items defined in config
      // This preserves the flexibility of the dynamic system while showing the core structure explicitly
      if (function_exists('render_additional_menu_items')) {
        echo render_additional_menu_items($admin_menu, $current_page, $admin_role);
      }
      ?>
    </ul>
  </nav>
