<label for="testimonialSortOrder" class="form-label">Default Sort Order</label>
    ...
    $(document).ready(function() {
        ...
        $('.edit-testimonial').click(function() {
            ...
            <?php echo "const testimonials = " . json_encode($testimonials) . ";"; ?>
        ...
        $('.edit-partner').click(function() {
            ...
            // For this example, we'll use our mock data
            <?php echo "const partners = " . json_encode($partners) . ";"; ?>
...
<head>
    ...
    <title>Testimonials & Partners - Backsure Global Support</title>
                ...
                <ul>
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            ...
                            <li><a href="admin-testimonials.php" class="active">Testimonials</a></li>
        ...
        <div class="admin-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <h1>Testimonials & Partners</h1>
                    <div class="breadcrumb">
                        <a href="admin-dashboard.php">Dashboard</a> / <span>Testimonials & Partners</span>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <form action="admin-testimonials.php" method="post">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <label for="testimonialSortOrder" class="