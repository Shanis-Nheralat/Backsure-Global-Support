...
<!-- Main Content Area -->
<main class="admin-main"><a class="back-blog-button" href="admin-blog.html">← Back to Blog List</a><!-- TODO: Enforce add/edit permissions here when backend is integrated -->
<!-- Top Navigation Bar -->
...
<button class="btn-secondary" id="preview-post">
<i class="fas fa-eye"></i> Preview
            </button>
<button class="btn-primary" id="publish-post">
...
<input id="post-title" placeholder="Enter post title..." type="text"/>
</div>
<!-- Post URL Preview -->
...
<span class="editable-slug" contenteditable="true" id="post-slug">post-title</span>
...
<textarea id="post-excerpt" placeholder="Enter post excerpt..." rows="3"></textarea>
...
<input id="publish-date" placeholder="Select Date &amp; Time" type="text"/>
</div>
<div class="form-group">
...
<input id="post-password" type="password"/>
</div>
<div class="form-actions">
<button class="btn-default" id="save-draft-sidebar">
<i class="fas fa-save"></i> Save Draft
                  </button>
<button class="btn-primary" id="publish-post-sidebar">
<i class="fas fa-paper-plane"></i> Publish
                  </button>
</div>
</div>
...
<input id="cat-business" name="category[]" type="checkbox" value="business-growth"/>
<label for="cat-business">Business Growth</label>
</div>
<div class="checkbox-group">
<input id="cat-outsourcing" name="category[]" type="checkbox" value="outsourcing"/>
<label for="cat-outsourcing">Outsourcing Tips</label>
</div>
<div class="checkbox-group">
<input id="cat-hr" name="category[]" type="checkbox" value="hr-management"/>
<label for="cat-hr">HR Management</label>
</div>
<div class="checkbox-group">
<input id="cat-finance" name="category[]" type="checkbox" value="finance"/>
<label for="cat-finance">Finance &amp; Accounting</label>
</div>
<div class="checkbox-group">
<input id="cat-insurance" name="category[]" type="checkbox" value="insurance"/>
<label for="cat-insurance">Insurance Updates</label>
</div>
<div class="checkbox-group">
<input id="cat-compliance" name="category[]" type="checkbox" value="compliance"/>
<label for="cat-compliance">Compliance &amp; Admin</label>
</div>
</div>
<div class="add-new-category">
<button class="btn-default" id="add-category-btn">
...
<div class="widget-content">
<div class="form-group">
<input id="post-tags" placeholder="Add tags, separated by commas..." type="text"/>
</div>
...
<div class="form-actions">
<button class="btn-default" id="upload-image-btn">
<i class="fas fa-upload"></i> Upload Image
                  </button>
<button class="btn-default" id="remove-image-btn" style="display: none;">
...
<input id="meta-title" placeholder="SEO Title" type="text"/>
<div class="character-count">
...
<textarea id="meta-description" placeholder="SEO Description" rows="3"></textarea>
<div class="character-count">
...
<input id="meta-keywords" placeholder="keyword1, keyword2, ..." type="text"/>
</div>
</div>
</div>
</div>
...
<input id="category-slug" placeholder="Enter category slug" type="text"/>
</div>
<div class="form-group">
...
<input placeholder="Search media..." type="text"/>
<button type="button">
<i class="fas fa-search"></i>
</button>
</div>
...
<img alt="Media Item" src="images/blog/placeholder-1.jpg"/>
</div>
...
<div class="media-item" data-type="image">
<div class="media-preview">
<img alt="Media Item" src="images/blog/placeholder-2.jpg"/>
</div>
<div class="media-info">
...
<div class="media-item" data-type="image">
<div class="media-preview">
<img alt="Media Item" src="images/blog/placeholder-3.jpg"/>
</div>
<div class="media-info">
...
<div class="media-item" data-type="image">
<div class="media-preview">
<img alt="Media Item" src="images/blog/placeholder-4.jpg"/>
</div>
<div class="media-info">
...
<input id="file-input" multiple="" style="display: none;" type="file"/>
</div>
...
<script src="admin/js/admin-blog-add.js"></script>
</body>
</html>
